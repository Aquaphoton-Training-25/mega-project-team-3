...
class MyWidget(QWidget):
    ...
    def button1_clicked(self):
        ...
        cam2 = np.array([[4396.869, 0, 1538.86],
                         [0, 4396.869, 989.702],
                         [0, 0, 1]])
        left_image = "im0_0.png"
        right_image = "im0_1.png"
        vmin = 17
        vmax = 619
        baseline = 144.094
        self.start_program(left_image, right_image, cam1, cam2, vmin, vmax,baseline)
    ...
    def button2_clicked(self):
        ...
        cam2 = np.array([[4396.869, 0, 1538.86],
                         [0, 4396.869, 989.702],
                         [0, 0, 1]])
        left_image = "im1_0.png"
        right_image = "im1_1.png"
        vmin = 17
        vmax = 619
        baseline = 144.049
        self.start_program(left_image, right_image, cam1, cam2, vmin, vmax,baseline)
    ...
    def button3_clicked(self):
        ...
        left_image = "im2_0.png"
        right_image = "im2_1.png"
        vmin = 54
        vmax = 147
        baseline = 177.288
        self.start_program(left_image, right_image, cam1, cam2, vmin, vmax,baseline)

    def start_program(self, left_image_path, right_image_path, Cam1, Cam2, vmin, vmax,baseline):
        ...
        rectify.create()
        disparity_process = disparity(vmin, vmax, rectify)
